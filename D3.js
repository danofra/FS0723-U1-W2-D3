...
switch (starWarsCharacters[i].eye_color) {
  ...
  default: console.log("non trovo nessun colore")
}
}
...
let count = 0;
  while (count < 10) 
  {
  let totalMass = starWarsCharacters[length].mass;
...
*/
console.log('numbers before modification: ', charactersNames.length)
...
console.log('numbers after modification: ', charactersNames.length) 
/* --EXTRA-- ESERCIZIO 10
